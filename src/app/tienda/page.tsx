...
export default function TiendaPage() {
  return (
    <main className="flex flex-col min-h-screen bg-pearl pt-[100px]">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1400px] px-4 md:px-8 py-10 flex flex-col grow">
        <header className="mb-10 text-center md:text-left">
          <nav className="flex items-center justify-center md:justify-start gap-2 text-sm text-navy-light/60 font-body mb-4" aria-label="Breadcrumb">
          ...
          <p className="font-body text-navy-light/70 text-lg">Sales naturales de los mares de Ecuador, directo a tu mesa.</p>
        </header>
